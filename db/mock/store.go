...
// Source: github.com/kartikeysemwal/goLangBackend/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResults, error) {
	m.ctrl.T.Helper()
